...
def eliminar_contacto():
    nombreEliminar = input("Ingrese el nombre del contacto que desea eliminar: ")
    if nombreEliminar in contactos_telefono:
        del contactos_telefono[nombreEliminar]
        print("Contacto eliminado con éxito.")
    else:
        print("El contacto", nombreEliminar, "no se encuentra en la lista de contactos.")
